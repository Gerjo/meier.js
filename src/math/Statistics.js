...
define(function(require) {
    ...
    var self = {
        ...
        UnbiasedCovariance: function (data1, data2) {
        ...
        RepeatingCombinations: function (n, k) {
            return Factorial(k + n - 1) / (Factorial(k) * Factorial(n - 1));
        },

        Variations: function (n, k) {
        ...
        /// less than 2.
        PercentileOf: function(data, number) {
            return data.reduce(function(a, b) {
                if(b < number) {
                    return a + 1;
                }
        ...
        /// ---------- * (n + 1)
        ///    100  
        PercentileReverse: function(data, percentile) {    
        ...
        StandardScore: function(data, number) {
        ...
        StandardNormalLookup: function(value) {
